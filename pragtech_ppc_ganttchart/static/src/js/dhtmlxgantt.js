...
GanttChart.prototype.doLoadDetails = function(isLocal)
{
    ...
    for (var j = 0; j < projectArr.length; j++)
    {
        ...
        for (var i = 0; i < taskArr.length; i++) {
            ...
            console.log('callingggggggggggggg1111 addTask funstion-----------')
...
GanttTask.prototype.getPopUpInfo = function(object, event)
{
    ...
    tblInfo.rows[0].cells[0].innerHTML = "<div style='font-family: Arial, Helvetica, Sans-serif; font-size: 12px;color: #688060; margin: 0 0 4px 0;'>" + this.TaskInfo.Name + "</div>";
...
GanttProject.prototype.getPopUpInfo = function(object, event)
{
    ...
    var tblInfo = this.Chart.divInfo.lastChild;
    tblInfo.rows[0].cells[0].innerHTML = "<div style='font-family: Arial, Helvetica, Sans-serif; font-size: 12px; color: #688060; margin:0 0 4px 0;'>" + this.Project.Name + "</div>";
...
GanttProject.prototype.createProjectNameItem = function()
{
    ...
    divName.style.cssText = "cursor:pointer;color:#003366;font-size:12px;font-family:Tahoma,Arial;white-space:nowrap;height:15px;z-index:1;position:absolute;left:" + 5 + "px;top:" + this.posY + "px;";
...
contextMenu.prototype.createTabPanel = function()
{
    ...
    this.tabPanel.firstChild.rows[0].cells[0].style.cssText = ";height:26px;background:url(" + this.Chart.imgs + "/menu/window_tr.png);background-repeat: no-repeat;color:#fff;font-size:14px;font-family: Tahoma, Arial";
